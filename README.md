...
> Free open-source SEO CLI toolkit (19 tools, pure Python stdlib, zero dependencies): keyword research, SERP difficulty scoring, site audit, GEO/AI-search scoring, rank tracking — runs on free API tiers, no paid tools required.
